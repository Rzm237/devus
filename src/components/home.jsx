...
import ImgWeb from "../image/webdev.jpg"; // Image service Web
import ImgCloud from "../image/cloud.png"; // Image Cloud
import ImgAI from "../image/ai.jpg"; // Image IA/ML
import ImgMobile from "../image/mobile.jpg"; // Image mobile app
import ImgUIUX from "../image/uiux.jpg"; // Image design UI/UX
import ImgProject from "../image/project.jpg"; // Image projets récents
    ...
    <div className="grid gap-y-32">
      ...
      sm:grid-cols-2  grid grid-cols-2  bg-[var(--greenhome-color)] h-64 w-full  rounded-xl pl-4"
        ...
        <div className=" grid xl:grid-cols-4 sm:grid-cols-2 md:grid-cols-3 gap-8 w-full ">
          <div className="h-48">
            <p className="font-bold text-[30px]">Our Expertise</p>
            <p className="text-[15px] text-justify w-62 my-4">
              Building innovative solutions to empower businesses.{" "}
            </p>
          ...
          <div className="">
            <img
              ...
              className=" rounded-xl h-48 w-72"
            />
            <p className="font-semibold text-lg">Cloud & DevOps</p>
